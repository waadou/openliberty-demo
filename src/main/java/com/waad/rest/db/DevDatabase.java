...
public class DevDatabase implements Database {
    ...
    private void loadUsers() {
        List<User> initialUsers = List.of(new User[]{
            User.of("alz", "Alassani ABODJI", "Developer"),
            User.of("djim", "WOETOWOU Yaovi", "developer & teacher"),
            User.of("abolo", "Komi ABOLO-SEWOVI", "Developer & teacher"),
            User.of("akpene", "Grace AMOUZOU", "Developer & teacher"),
            User.of("shama", "Shama GAGNON", "Developer"),
