 ...
 */
@ApplicationScoped
public class ProdDatabaseImpl implements ProdDatabase {

    private final Map<String, User> users = new HashMap<>();

    public ProdDatabaseImpl() {
        loadUsers();
    }
    ...
    private void loadUsers() {
        List<User> initialUsers = List.of(new User[]{
            User.of("dnathaly", "Nathaly DEPARDY", "CEO"),
            User.of("jleon", "Leon JOLLY", "Manager"),
            User.of("dovonh", "Dian OVONH", "Maintainer"),
            User.of("fgerard", "Gerard ADDY", "Developer"),
            User.of("dlamard", "Lorent DUGRAND", "Teacher")
        });
